...
const RULES: SuggestionRule[] = [
  {
    ...
    substrings: [
      'UBER EATS', 'UBEREATS', 'PEDIDOSYA', 'PEDIDOS YA', 'RAPPI',
      'RESTAURANT', 'RESTAURANTE', 'CAFETERIA', 'COFFEE', 'STARBUCKS',
      'MCDONALD', 'MC DONALD', 'BURGER', 'PIZZA', 'CAMPERO', 'POLLOLANDIA',
  ...
  },
  {
    category: 'Fuel',
    substrings: [
      'GASOLINERA', 'GASOLINA', 'COMBUSTIBLE', 'TEXACO', 'SHELL',
      'ESTACION DE SERVICIO', 'FUEL', 'CHEVRON', 'ESSO', 'PETRO',
    ],
    words: ['PUMA', 'UNO', 'GAS'],
  },
  {
    category: 'Transport',
    substrings: [
      'UBER', 'INDRIVER', 'IN DRIVER', 'TAXI', 'PARQUEO', 'PARKING',
      'PEAJE', 'AUTOPISTA', 'TRANSPORTE', 'TRANSURBANO', 'AUTOBUS',
      'RENTA CAR', 'RENT A CAR', 'CAR WASH', 'AUTOLAVADO', 'TALLER',
      'REPUESTOS', 'LLANTAS',
    ],
  ...
  },
  {
    category: 'Travel',
    substrings: [
      'HOTEL', 'AIRBNB', 'BOOKING', 'EXPEDIA', 'DESPEGAR', 'AEROLINEA',
      'AIRLINES', 'AVIANCA', 'LATAM', 'COPA AIR', 'AEROMEXICO', 'IBERIA',
      'UNITED', 'DELTA AIR', 'SPIRIT', 'VOLARIS', 'VUELO', 'MARRIOTT',
      'HILTON', 'HYATT', 'RESORT', 'HOSTAL', 'TRAVEL', 'VIAJES', 'TOUR',
    ],
  },
  {
    category: 'Health',
  ...
  },
  {
    ...
    substrings: [
      'NETFLIX', 'SPOTIFY', 'DISNEY', 'HBO', 'PARAMOUNT', 'PRIME VIDEO',
      'YOUTUBE', 'TWITCH', 'CINEPOLIS', 'CINEMARK', 'CINEMA', 'TEATRO',
      'PLAYSTATION', 'NINTENDO', 'XBOX', 'RIOT', 'EPIC GAMES', 'CONCIERTO',
      'BOLICHE', 'BILLAR', 'CASINO', 'MUSEO', 'ZOOLOGICO', 'IRTRA',
    ],
  ...
  },
  {
    category: 'Services',
    substrings: [
      'CLARO', 'TIGO', 'MOVISTAR', 'TELEFONICA', 'INTERNET', 'CABLE',
      'EEGSA', 'ENERGUATE', 'ENERGIA ELECTRICA', 'ELECTRICIDAD', 'EMPAGUA',
      'MUNICIPALIDAD', 'SEGUROS', 'SEGURO', 'INSURANCE', 'NOTARIA',
      'ABOGADO', 'CONTADOR', 'LAVANDERIA', 'BARBERIA', 'PELUQUERIA',
      'SALON DE BELLEZA', 'MICROSOFT', 'GOOGLE', 'APPLE.COM', 'ICLOUD',
      'DROPBOX', 'ZOOM.US', 'CANVA', 'ADOBE', 'GODADDY', 'HOSTING',
      'SUSCRIPCION', 'MEMBRESIA', 'COMISION', 'CUOTA DE MANEJO',
    ],
  ...
  },
  {
    category: 'Shopping',
    substrings: [
      'AMAZON', 'ALIEXPRESS', 'SHEIN', 'TEMU', 'EBAY', 'MERCADOLIBRE',
      'MERCADO LIBRE', 'ZARA', 'BERSHKA', 'PULL&BEAR', 'PULL & BEAR',
      'FOREVER 21', 'SIMAN', 'CEMACO', 'NOVEX', 'MEGAPACA', 'ALMACEN',
      'BOUTIQUE', 'ZAPATERIA', 'CALZADO', 'JOYERIA', 'PERFUMERIA',
      'ELEKTRA', 'MAX DISTELSA', 'INTELAF', 'KLIP', 'FERRETERIA', 'TIENDA',
      'DEPARTAMENTO', 'MALL', 'OAKLAND', 'MIRAFLORES', 'PRADERA', 'CAYALA',
    ],
    words: ['H&M', 'EPA'],
  },
];
